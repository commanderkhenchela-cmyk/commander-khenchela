...
/// شاشة إنشاء حساب موصّل جديد — الاسم + رقم الهاتف + كلمة سر فقط.
/// نوع المركبة "دراجة" ضمنيًا (المرحلة 1 دراجات فقط) — لا حقل اختيار.
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  String _friendlyError(String message) {
    if (message.contains('already registered') ||
      ...
      return 'رقم الهاتف هذا مسجَّل بالفعل (كموصّل أو في تطبيق آخر). '
          'جرّب تسجيل الدخول، أو استخدم رقمًا آخر.';
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('تسجيل موصّل جديد')),
      body: SafeArea(
